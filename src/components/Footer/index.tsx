          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-8 max-w-[270px] text-base text-gray-7">
                We craft world-class digital experiences that help startups and brands grow through technology, creativity, and innovation.
              </p>
          ...
          <div className="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="mt-6">
                ...
                <p className="mb-2 text-sm text-gray-7">
                  <Link href="mailto:info@trendysaas.com" className="hover:text-primary">
                    info@trendysaas.com
                  </Link>
                </p>
                <p className="text-sm text-gray-7">
                  <Link href="mailto:contact@trendysaas.com" className="hover:text-primary">
                    contact@trendysaas.com
                  </Link>
                </p>
              </div>
            </div>
        ...
        <div className="container">
          <div className="flex justify-center">
            <p className="text-base text-gray-7">
              © 2025 Trendy SaaS — Empowering the Next Generation of Digital Brands 🚀
            </p>
          </div>
        </div>
      </div>
