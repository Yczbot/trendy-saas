            ...
            <div className="w-full px-4">
              ...
              >
                ...
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                  Build, scale, and manage your digital presence with Trendy SaaS — a modern platform designed to simplify business growth through technology, creativity, and automation.
                </p>

                <div>
                  <p className="mb-4 text-center text-base font-medium text-white/60">
                    Fresh Minds. Bold Ideas. Limitless Possibilities.
                  </p>
                  <div
